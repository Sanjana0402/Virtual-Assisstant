...
def run_luna():
 ...
 try:
  ...
  if 'hello' in command :
     ...
     print('I am luna your virtual assistant .how can i help you ??')
     engine_talk('I am luna, your virtual assistant master. how can i help you ??')
...
# Textual month, day and year
     ...
     print('Setting alarm....')
     engine_talk('Please set alarm as per required')
     ...
     if __name__=="__main__":
  ...
  elif 'do calculation' in command:
      print('Doing calculations.....')
      engine_talk('Doing calculation.... Please give numbers for providing operations')
      ...
      print("I have been created by group12.")
      engine_talk("I have been created by Group 12.")
...
print('\n')
print("hello, i am luna  how can i help you ??")
engine_talk ("hello i am luna how can i help you ")
